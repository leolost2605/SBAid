...
from sbaid.model.simulator.vissim.vissim import VissimConnectorCrossSectionState, CommandQueue
...
class VissimCrossSection(SimulatorCrossSection):
    ...
    def __init__(self, command_queue: CommandQueue, state: VissimConnectorCrossSectionState):
        super().__init__()
